...
| 4 | Local payment provider | Provider module | Drafted (`TIER_B_LOCAL_PAYMENT_PROVIDER_MODULE.md` v1.0 — Draft) | Provider choice; COD policy; now also needs pending/failed/cancelled/expired/retry state support | `07` |
