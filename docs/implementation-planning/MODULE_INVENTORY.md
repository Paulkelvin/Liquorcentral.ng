...
|---|---|---|---|---|---|
| `wine-details` (wine attributes) | Custom Module | Scoped (`MEDUSA_EXTENSIONS.md` #1); field list open | Product | Yes | `03`,`04`,`05`,`09`,`11` |
...
- **Which are custom?** `wine-details`, `food-details`, delivery-slot scheduling, the Product Relationship Module (architecture now approved), and Saved-for-Later (not yet scoped).
