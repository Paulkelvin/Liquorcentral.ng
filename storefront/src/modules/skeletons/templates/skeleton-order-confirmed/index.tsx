...
const SkeletonOrderConfirmed = () => {
  return (
    <div className="bg-ink-100 py-6 min-h-[calc(100vh-64px)] animate-pulse">
      <div className="ds-container flex justify-center">
        <div className="max-w-4xl h-full bg-surface-elevated w-full p-10">
