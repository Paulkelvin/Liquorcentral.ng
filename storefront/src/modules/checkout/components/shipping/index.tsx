        ...
        <>
          <div className="grid">
            <div className="flex flex-col">
              <span className="font-medium txt-medium text-text-primary">
                Shipping method
              </span>
              <span className="mb-4 text-text-muted txt-medium">
                ...
                {hasPickupOptions && (
                  ...
                  >
                    ...
                    >
                      ...
                      <span className="justify-self-end text-text-primary">
                        -
                      </span>
                    </Radio>
                  </RadioGroup>
