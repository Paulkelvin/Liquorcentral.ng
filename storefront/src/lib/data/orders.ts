...
export const retrieveOrder = async (id: string) => {
  ...
  return sdk.client
    .fetch<HttpTypes.StoreOrderResponse>(`/store/orders/${id}`, {
      ...
      query: {
        fields:
          "*payment_collections.payments,*items,*items.metadata,*items.variant,*items.product,+items.product.food_details.*,+items.product.wine_details.*,+metadata",
      },
      headers,
      next,
      cache: "force-cache",
  ...
  return sdk.client
    .fetch<HttpTypes.StoreOrderListResponse>(`/store/orders`, {
      ...
      query: {
        ...
        order: "-created_at",
        fields:
          "*items,+items.metadata,*items.variant,*items.product,+items.product.food_details.id,+items.product.wine_details.id,+metadata",
        ...filters,
      },
      headers,
      next,
